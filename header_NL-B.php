...
<html lang="en">
  ...
  <body>
    <header>
      <nav class="navbar navbar-expand-lg navbar-light bg-faded menu-relative fixed-top" style="background-color: white">
        <div class="container">
	 ...
	 <section id="openLogin" class="modalDialogMurci">
			...
			<section id="openLoginE" class="modalDialogMurci" onload="mostraLogin(2,1)">
				<section class="modalMurci">
