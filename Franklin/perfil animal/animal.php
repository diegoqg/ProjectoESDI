...
<html lang="es">
	...
	<body>
		...
		<?php
			...
			$sql = "SELECT mascota.nombre AS nombreMascota, protectora.nombre, mascota.edat, mascota.sexo, mascota.tamaño, mascota.descripcion, protectora.direccion, mascota.imagenPerfil, mascota.imagen1, mascota.imagen2 FROM mascota join protectora using (idProtectora) WHERE idMascota = 1";
			    ...
			    echo "
			   	 <section class='modal-item uno'>
					    ...
					    <div class=\"linkProtectora\">
					    	<a href=\"www.google.es\"><img src=\"caseta.png\">".$line[$nombre]."</a>
						</div>
					    <br>
